...
public class Controleur {
	...
	// Comme il n'existe pas d'objet ihm à proprement parlé, simplement des affichages ou des lectures
	...
	/**
	 * Affiche l'identité du joueur qui n'est pas actif et affiche ensuite le menu du joueur actif
	 * @param choixMenuJoueurActif contient l'entier correspondant au menu du joueur actif
	 * @param titreJoueurActif contient la chaine de caractères permettant d'identifier qui est le joueur actif,
	 * 			à savoir "joueur 1" ou "joueur 2"
	 * @param msgAutreIdentite contient la chaine de caractères indiquant qu'il s'agit bien de l'identité de
	 * 			l'autre joueur, par exemple << "identité du joueur 2 = "+nom du joueur 2  >>
	 ...
	 * @param titreJoueurActif contient la chaine de caractères permettant d'identifier qui est le joueur actif
	 * 			à savoir "joueur 1" ou "joueur 2"
	 * @param joueurActif le joueur actif qui va évoluer dans son score
	...
	public void jouer(){
		...
		while (!fini) {
			...
			if (joueur1.isGagnant() || joueur2.isGagnant()){
				...
				if (joueur1.isPerdant()||joueur2.isPerdant()){
	...
	/**
	 * Demande un affichage des scores actuels dans la console.
